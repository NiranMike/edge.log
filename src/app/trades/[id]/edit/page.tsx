      ...
      <div className="min-h-full px-4 py-6 sm:px-6 sm:py-10 lg:py-14 flex flex-col items-center">
        ...
        <div className="w-full max-w-[640px]">
          <nav className="flex items-center gap-1.5 mb-8 sm:mb-10">
            <a
              href="/trades"
              className="font-mono text-[11px] text-[var(--tx-3)] no-underline hover:text-[var(--tx-1)] transition-colors duration-150 tracking-[0.04em]"
            >
              Trades
            </a>
            <span className="font-mono text-[11px] text-[var(--tx-4)]">/</span>
            <span className="font-mono text-[11px] text-[var(--tx-2)] tracking-[0.04em]">
              {trade.pair}
            </span>
            <span className="font-mono text-[11px] text-[var(--tx-4)]">/</span>
            <span className="font-mono text-[11px] text-[var(--tx-3)] tracking-[0.04em]">Edit</span>
          </nav>

          <div className="w-full mb-7 sm:mb-9 rounded-[6px] bg-[var(--bg-overlay)] border border-[var(--bd)] px-4 py-3">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-2.5">
                <span className="font-mono text-[9px] uppercase tracking-[0.16em] text-[var(--tx-4)]">
                  Original result
                </span>
                <span className={[
          ...
          <div className="w-full mt-10 sm:mt-12 pt-7 sm:pt-8 border-t border-[var(--bd)]">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="font-mono text-[11px] text-[var(--tx-3)] mb-[3px] tracking-[0.04em]">
                  Delete trade
                </p>
                <p className="font-mono text-[10px] text-[var(--tx-4)]">
